            ...
            <div className="w-full h-full bg-white relative">
                ...
                <DialogContent className="flex flex-col items-center gap-12 mt-[60px]">
                    <Stack className="relative">
                        <Image src={letter1} alt="Letter 1 Icon" width={94} height={60} className="relative z-10" />
                        <Image src={letter2} alt="Letter 2 Icon" width={94} height={60} className="absolute bottom-[-8px] right-[-10px] z-1" />
                    </Stack>
                    ...
                    <Stack className="flex flex-row justify-between items-center self-stretch m-auto gap-3">
                        {[0, 1, 2, 3].map((index) => (
                            <TextField
                                ...
                                inputProps={{ maxLength: 1, style: { textAlign: 'center', height: '60px' } }}
                                sx={{
                                    '& .MuiInputBase-root': {
                                        border: '#c6bed5',
                                        width: '60px',
