...
export default function UpdatedPasswordDialog({ open, onClose, onBack, onContinue }) {
    return (
        <Dialog
            onClose={onClose}
            ...
            <div className="w-full h-full bg-white relative">
                ...
                <DialogContent className="flex flex-col items-center gap-12 mt-[60px]">
                    <Stack className="relative">
                        <Image src={success} alt="Success Icon" width={82} height={82} className="relative" />
                    </Stack>
                    <Stack className="flex flex-col items-center gap-6 self-stretch">
                        ...
                        >
                            Artık yeni şifrenizi kullanarak hesabınıza <span className='text-primary-600'>giriş yap</span>abilirsiniz.
                        </Typography>
                    </Stack>
                </DialogContent>
                <DialogActions className="flex flex-col w-full justify-center gap-6 items-center">
                    <Button onClick={onContinue} className="h-12 w-[100%] max-w-[420px] rounded-lg bg-primary-600 text-white font-sans text-[14px] font-[500px]"
                        sx={{
                            '&:hover': {
                    ...
                    Şifrenizi unuttuğunuzda aynı adımları izleyerek yeni bir şifre oluşturabilirsiniz. Güvenliğiniz için şifrenizi kimseyle paylaşmayın.
                    </Typography>
                </DialogActions>
            </div>
        </Dialog>
